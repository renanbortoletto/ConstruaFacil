    ...
    public void setUp() throws MalformedURLException {
        ...
        switch (ambiente) {
            ...
            case "remoto": // No SauceLabs
                ...
                desiredCapabilities.setCapability("appActivity", "com.android.calculator2.Calculator");
                desiredCapabilities.setCapability("ensureWebviewsHavePages", true);
                desiredCapabilities.setCapability("SAUCE_USERNAME", "oauth-bortolettorenan1-8c671");
                desiredCapabilities.setCapability("SAUCE_ACCESS_KEY", "95e64fba-907d-4f41-ad9f-7f7ff798efe7");

                remoteUrl = new URL("https://oauth-bortolettorenan1-8c671:95e64fba-907d-4f41-ad9f-7f7ff798efe7@ondemand.us-west-1.saucelabs.com:443/wd/hub");
                break;
            default:
                remoteUrl = new URL("http://localhost:4723/wd/hub");
                break;
