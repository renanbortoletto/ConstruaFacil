...
@Test
@CucumberOptions(
        features = {"src/test/resources/featuresPOEN"}, // Onde estao os cenarios em Gherkin
        glue = {"stepsPOEN"},                           // Onde estao as definicoes de passos
...
public class RunnerEN extends AbstractTestNGCucumberTests {
}
